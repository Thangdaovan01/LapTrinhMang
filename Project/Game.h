...
void xuatMotCauHoi(Node *head, char *outString){
    Node *p=head;
    //printf("%s\nA. %s\nB. %s\nC. %s\nD. %s\n",p->data.CauHoi,p->data.TraLoi.A,p->data.TraLoi.B,p->data.TraLoi.C,p->data.TraLoi.D);  
    char send_buff[500];
    strcpy(send_buff,p->data.CauHoi);
    strcat(send_buff,"\nA. ");
    strcat(send_buff,p->data.TraLoi.A);
    strcat(send_buff,"\nB. ");
    strcat(send_buff,p->data.TraLoi.B);
    strcat(send_buff,"\nC. ");
    strcat(send_buff,p->data.TraLoi.C);
    strcat(send_buff,"\nD. ");
    strcat(send_buff,p->data.TraLoi.D);
    strcat(send_buff,"\n.");
    strcpy(outString, send_buff);
}
